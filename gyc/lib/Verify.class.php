...
class Verify
{
    ...
    public function check($code, $id = '')
    {
        ...
        if (time() - $secode['verify_time'] > $this->expire) {
            //session($key, null);
            $this->lSession->set('gyc', $key, null);
            return false;
        }

        if ($this->authcode(strtoupper($code)) == $secode['verify_code']) {
            $this->reset && ($this->lSession->set('gyc', $key, null));//session($key, null);
            return true;
        }
    ...
    public function entry($id = '')
    {
        ...
        $this->lSession->set('gyc', $key . $id, $secode);
